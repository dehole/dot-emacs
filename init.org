...
* About
  ...
  This emacs configuration started from the work that Lars Tveito put into his
  emacs org file [[https://github.com/larstvei/dot-emacs][here]].

  Another literate org file reference can be found [[http://mescal.imag.fr/membres/arnaud.legrand/misc/init.php][Here]]. 
   ...
   (let* ((package--builtins nil)
          (packages
           '(auto-compile         ; automatically compile Emacs Lisp libraries
             ...
             ob-kotlin            ; org-babel functions for kotlin evaluation
             ob-async             ; org-babel functions for async operations
             ob-rust              ; org-babel functions for rust evaluation
             ob-tmux              ; org-babel functions for tmux operations
             org                  ; Outline-based notes management and organizer
             org-ref              ; citations bibliographies in org-mode
             ox-pandoc            ; Exporter for Org mode to pandoc
             paredit              ; minor mode for editing parentheses
             pdf-tools            ; Emacs support library for PDF files
             projectile           ; Manage and navigate projects in Emacs easily
             pyvenv               ; Python virtual environments
             pyenv-virtualenv     ; virtualenv plugin
...
** Windows 10
   ...
   Note: This is a work in progress.  So far it doesn't seem to work.

   #+BEGIN_SRC emacs-lisp
   (when (memq window-system '(w32 win32 windows-nt))
...
** Visual
   ...
   (defun cycle-themes ()
     ...
     (lexical-let ((themes '#1=(material . #1#)))
       (lambda ()
         (interactive)
   ...
   Use the [[http://www.levien.com/type/myfonts/inconsolata.html][Inconsolata]] font if it's installed on the system. For Ubuntu it can
   be installed by using apt-get: [[https://blog.programster.org/ubuntu-14-04-install-inconsolata-monospace-font][Instructions]]. For Windows, it can be
   installed by first downloading the OpenType file from Inconsolata's website,
   and then installing it by right clicking the file and select Install.
...
** Org Babel
   ...
   Org makes it easy to include source code blocks alongside text passages and
   then execute it with Org Babel.
   ...
   There are some additional options that we can include.
...
*** References
**** [[http://cachestocaches.com/2018/6/org-literate-programming/][org-literate-programming]]
